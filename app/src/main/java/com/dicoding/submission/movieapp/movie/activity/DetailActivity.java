...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Movie movie = getIntent().getParcelableExtra(DETAIL_MOVIE);
    ...
    public boolean Exists(String searchItem) {
        ...
        Cursor cursor = db.query(DatabaseContract.FavoriteEntry.TABLE_NAME, projection, selection, selectionArgs, null, null, null, limit);
    ...
    private void removeFromFavorite(int movie_id) {
        if (getIntent().getData() != null) {
            ...
            getContentResolver().delete(Uri.parse(CONTENT_URI+"/"+movie_id), COLUMN_MOVIEID, null);
        }
    }
